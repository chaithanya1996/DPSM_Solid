...
TEST: DPSM_testing.cpp helper.o core.o interface.o
	$(CC) DPSM_testing.cpp dpsm_helpers.o  dpsm_core.o dpsm_interface.o   -o DPSM_testing.o  $(CFLAGS)
POST: DPSM_time_post.cpp helper.o core.o interface.o
	$(CC) DPSM_time_post.cpp dpsm_helpers.o  dpsm_core.o dpsm_interface.o   -o DPSM_time_post.o  $(CFLAGS)
